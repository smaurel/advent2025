...
const mainInputs = import.meta.glob("../days/day*/input.txt", { query: "?raw", eager: true }) as Record<string, string>;
const testInputs = import.meta.glob("../days/day*/test.txt", { query: "?raw", eager: true }) as Record<string, string>;
